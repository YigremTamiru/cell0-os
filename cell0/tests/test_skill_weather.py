...
sys.path.insert(0, '/Users/yigremgetachewtamiru/.openclaw/workspace/skills/weather')
...
# Change to the weather directory for proper imports
os.chdir('/Users/yigremgetachewtamiru/.openclaw/workspace/skills/weather')
