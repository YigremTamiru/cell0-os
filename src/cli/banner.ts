...
export function formatBannerLine(version: string): string {
...
export function formatBannerArt(): string {
    const rich = isRich();
...
export function emitBanner(version: string): void {
    ...
    if (argv.some((a) => a === "--json" || a === "--version" || a === "-V")) return;
...
export function emitBannerArt(version: string): void {
    if (!process.stdout.isTTY) return;
...
export function hasEmittedBanner(): boolean {
