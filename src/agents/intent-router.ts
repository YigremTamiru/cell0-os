...
import { type Specialist } from "../library/manifest.js";
...
export class IntentRouter {
     ...
     */
    async scoreIntent(text: string, contextWindow?: string[]): Promise<IntentScore> {
        ...
        try {
            ...
            const result = await this.bridge.post<IntentScore>("/api/col/classify", {
                text,
     ...
     */
    private fallbackHeuristicScore(text: string): IntentScore {
